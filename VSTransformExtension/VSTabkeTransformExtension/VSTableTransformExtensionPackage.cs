...
namespace VSTableTransformExtension
{
    ...
    {
        /// <summary>
        /// VSTableTransformExtensionPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "c4ebfc45-a5e2-46c4-967c-276f4cdc8849";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await TransformCommand.InitializeAsync(this);
        }
